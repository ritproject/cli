defmodule RitCLI.CLI.Config.Server do
  ...
  @spec has_server?(String.t()) :: boolean
  ...
  @spec set_default_server(Server.Default.Input.Set.t()) ::
          {:ok, Server.t()} | {:error, atom, Output.t()}
  def set_default_server(%Server.Default.Input.Set{} = input) do
    set_default_server(input, get_config())
  end

  @spec set_default_server(Server.Default.Input.Set.t(), Server.t()) ::
          {:ok, Server.t()} | {:error, atom, Output.t()}
  def set_default_server(%Server.Default.Input.Set{} = input, %Server{} = config) do
    Server.Default.Operations.set_default_server(input, config)
  end

  @spec unset_default_server(Server.Default.Input.Unset.t()) ::
          {:ok, Server.t()} | {:error, atom, Output.t()}
  def unset_default_server(%Server.Default.Input.Unset{} = input) do
    unset_default_server(input, get_config())
  end

  @spec unset_default_server(Server.Default.Input.Unset.t(), Server.t()) ::
          {:ok, Server.t()} | {:error, atom, Output.t()}
  def unset_default_server(%Server.Default.Input.Unset{} = input, %Server{} = config) do
    Server.Default.Operations.unset_default_server(input, config)
  end
end
